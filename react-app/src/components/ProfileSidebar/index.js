        ...
        <div id="profile-sidebar-cntr">
            <div id="profile-top-header">
              ...
              <img
                ...
                alt="profile"
                />
              <div id="profile-greeting-text" className="text">Hi, <br/> <div id="profile-current-user-name" className="text">{currentUser.first_name}</div></div>
                </div>
            <div>
                ...
                <a href="/order-history" className="text">My Order History</a>
                </li>
            </div>
        </div>
    )
